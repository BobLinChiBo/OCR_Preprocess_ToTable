...
class TwoStageOCRPipeline:
    ...
    def __init__(self, stage1_config: Stage1Config = None, stage2_config: Stage2Config = None):
        ...
        for image_path in image_files:
            try:
                ...
                for i, page in enumerate([left_page, right_page], 1):
                    ...
                    reconstruction_dir = self.stage1_config.output_dir / "04_table_reconstruction"
                    reconstruction_path = reconstruction_dir / f"{page_name}_reconstructed.jpg"
    ...
    def run_stage2(self, input_dir: Path = None) -> List[Path]:
        ...
        for image_path in image_files:
            try:
                ...
                reconstruction_dir = self.stage2_config.output_dir / "03_table_reconstruction"
                reconstruction_path = reconstruction_dir / f"{base_name}_final_reconstructed.jpg"
    ...
    def run_complete_pipeline(self, input_dir: Path = None) -> List[Path]:
        ...
        print(f"   Check final results in: {self.stage2_config.output_dir / '04_fitted_tables'}")
