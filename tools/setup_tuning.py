...
def print_file_copy_examples():
    ...
    print("# Linux/Mac:")
    print("cp data/output/tuning/01_split_pages/best_folder/*.jpg data/output/tuning/02_deskewed_input/")
    print("# Windows:")
    print("copy \"data\\output\\tuning\\01_split_pages\\best_folder\\*.jpg\" \"data\\output\\tuning\\02_deskewed_input\\\"")
    
    print("\nAfter Deskewing:")
    print("# Linux/Mac:")
    print("cp data/output/tuning/02_deskewed/best_folder/*.jpg data/output/tuning/03_roi_input/")
    print("# Windows:")
    print("copy \"data\\output\\tuning\\02_deskewed\\best_folder\\*.jpg\" \"data\\output\\tuning\\03_roi_input\\\"")
    
    print("\nAfter ROI Detection:")
    print("# Linux/Mac:")
    print("cp data/output/tuning/03_roi_detection/best_folder/*_roi.jpg data/output/tuning/04_line_input/")
    print("# Windows:")
