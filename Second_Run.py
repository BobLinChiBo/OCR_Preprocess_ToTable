...
def run_script_with_config(script_name, config_path="config_second.json"):
...
if __name__ == "__main__":
    ...
    config_path = "config_second.json"
    ...
    for script in scripts:
        try:
            ...
            print(f"Error: {script} not found. Make sure it's in the same directory as Second_Run.py or its path is correct.")
            sys.exit(1)
