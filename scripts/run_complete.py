...
Examples:
  ...
  python run_complete.py --stage2-only       # Run only Stage 2
    ...
    parser.add_argument(
        ...
        type=int,
        default=40,
        help="Stage 1 min line length for table detection (default: 40)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help="Stage 2 min line length for refined detection (default: 30)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Stage 2 max line gap for refined detection (default: 5)",
    )
    ...
    parser.add_argument(
        "--stage1-config",
        type=Path,
        help="Path to Stage 1 JSON config (default: configs/stage1_default.json)",
    )

    parser.add_argument(
        "--stage2-config",
        type=Path,
        help="Path to Stage 2 JSON config (default: configs/stage2_default.json)",
    )
